...
from causalmath.algorithm.pns_cot import calculate_ps_pn as test_original_metrics
...
def main():
    ...
    import causalmath.algorithm.pns_cot as pnps_module
    from causalmath.utils.prompts import common_prompt, math_prompt
    ...
    with open(input_file, "r", encoding="utf-8") as f_in, \
        ...
        def process_and_write(line, lnum):
            ...
            try:
                ...
                with write_lock:
                    ...
                    log.flush()
                print(f"{Fore.GREEN}[L{lnum}] done{Style.RESET_ALL}")
                return lnum, None
                ...
                with write_lock:
                    ...
                    log.flush()
                print(f"{Fore.RED}[L{lnum}] failed: {e}{Style.RESET_ALL}")
                return lnum, e
        ...
        with ThreadPoolExecutor(max_workers=workers) as ex:
            ...
            for line in f_in:
                line_num += 1
                fut = ex.submit(process_and_write, line, line_num)
                futures[fut] = line_num
